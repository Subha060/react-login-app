...
export default function SignInThree() {
  ...
  // Toggling function for SignIn and SignUp
  ...
  return isSignIn ? (
        ...
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <a
              ...
              onClick={toggleForm} // Toggle between SignIn and SignUp
            >
    ...
    <SignUpThree toggleForm={toggleForm} />
  )
}
...
function SignUpThree({ toggleForm }: { toggleForm: () => void }) {
  return (
    <section>
        ...
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          ...
          <p className="mt-2 text-center text-base text-gray-600">
            ...
            <a
              ...
              onClick={toggleForm} // Toggle between SignUp and SignIn
            >
              Sign In
            </a>
          </p>
